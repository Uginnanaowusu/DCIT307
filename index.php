...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:50px" id="showcase">
    ...
    <h1 class="w3-xxxlarge"><b>Welcome to Eugene's Lorry Services</b></h1><br>
    <h3 class="w3-xxlarge w3-text-green"><b>Ghana's Numero UN (NO1) best truck services.</b></h3>
  ...
  <div class="w3-container" id="services" style="margin-top:75px">
    ...
    <hr style="width:50px;border:5px solid green" class="w3-round">
    <p>We are a Ghana's no1 transport service that focus on the fast and safe delivery of the goods. </p>
    <p>Covering all modes of transport, we provide you with the services you need to meet your customers' demands. Based on your business need, our team can suggest the most effective and efficient service available. At the heart of our service is our commitment to customers service and quality. With 9 years experience delivering excellence, our focus has always been solely on not letting our customers down.
	Think together. Move together. Succeed together.
    </p>
  </div>
