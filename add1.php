...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:50px" id="showcase">
	...
	<h1 class="w3-xxxlarge"><b>Eugene Lorry Service</b></h1>
    <h3 class="w3-xlarge w3-text-green"><b>Ghana's Numero UN (NO1) best truck services.</b></h3><br>

  <h3 class="w3-xxlarge w3-text-black"><b>Add Vehicle and Company</b></h3>
  <hr style="width:450px;border:5px solid green" class="w3-round">
