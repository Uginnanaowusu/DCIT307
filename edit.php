...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <!-- Header -->
	...
	<h1 class="w3-xxxlarge"><b>Eugene's Lorry Service</b></h1>
    <h3 class="w3-xlarge w3-text-green"><b>Ghana's Numero UN (NO1) best truck services.</b></h3><br>
...
<tr><td></td><td>Enter the serial number : </td><td><input type="text" name="sno"></td><td><input class="btn btn-success" type="submit" value="Click to continue"></td>
